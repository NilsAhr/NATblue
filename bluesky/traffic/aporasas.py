...
class APorASAS(TrafficArrays):
    ...
    def update(self):
        ...
        # ASAS commanded speed is TAS directly (no GS/TAS conversion).
        # The old GS-to-TAS wind-subtraction conversion was removed to
        # prevent mathematical singularities at flight angles common on
        # North Atlantic routes (east/west headings with jetstream).
        # CR modules that use perf.limits() now return TAS directly.
